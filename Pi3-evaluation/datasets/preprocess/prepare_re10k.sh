...
# download metadata
mkdir /data/wanghaoxuan/re10k
cd /data/wanghaoxuan/re10k
#wget https://storage.cloud.google.com/realestate10k-public-files/RealEstate10K.tar.gz
curl -L -o RealEstate10K.tar.gz https://storage.googleapis.com/realestate10k-public-files/RealEstate10K.tar.gz
