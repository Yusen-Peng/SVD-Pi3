...
def main(hydra_cfg: DictConfig):
    ...
    if COMPRESSED and not USE_VGGT:
        ...
        if ADAPTIVE:
            ...
            if DIVERSE_CALI:
                cali_path = "experiments/SVD_Pi3_cache/curation/diverse_pi3_calib_nsamples256_size224_seed3.pt"
                save_path = "experiments/SVD-pi3/diverse_adaptive_cfg.json"
                print("🌈🌈🌈Using DIVERSE calibration dataset for learning adaptive cfg...🌈🌈🌈")
            
            else:
                cali_path = "experiments/SVD_Pi3_cache/curation/scannet_pi3_calib_nsamples256_size224_seed3.pt"
                save_path = "experiments/SVD-pi3/adaptive_cfg.json"
            ...
            if ADAPTIVE_MODE == 'input':
                if not AUGMENTED:
                    if not FINE_GRAINED:
                        ...
                        learn_entropy_cfg_continuous_from_calib(
                            calib=cali_white_data,
                            save_path='experiments/SVD-pi3/adaptive_cfg_finegrained.json',
                            bins=256,
                            rr_min=0.1,
                            rr_max=0.3,
                            rr_target=0.2,
                    ...
                    learn_augmented_entropy_cfg_from_calib(
                        calib=cali_white_data,
                        save_path='experiments/SVD-pi3/adaptive_cfg_augmented.json',
                        bins=256,
                        tail_frac=0.25,
                        rr_values=(0.1, 0.2, 0.3),
                        device=device
                ...
                learn_drift_cfg_from_calib(
                    calib=cali_white_data,
                    model=model,
                    save_path='experiments/SVD-pi3/adaptive_cfg_drifting.json',
                    tail_frac=0.25,
                    rr_values=(0.1, 0.2, 0.3),
                    device=device
                )
