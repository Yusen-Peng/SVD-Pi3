...
def run_phase(args, phase, ckpt_in, out_dir):
    ...
    merged_path = f"/scratch/path/to/SVD_Pi3_cache/LoRA/Pi3_lora_{phase}_0.2.safetensors"
...
def main():
    ...
    ckpt_u = run_phase(args, "U", args.prune_model, "/scratch/path/to/SVD_Pi3_cache/LoRA/first_half")
    _      = run_phase(args, "V", ckpt_u, "/scratch/path/to/SVD_Pi3_cache/LoRA/second_half")
